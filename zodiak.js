...
input.question("Masukkan tanggal lahir (1-31): ", function (inputTanggal) {
  input.question("Masukkan bulan lahir (1-12): ", function (inputBulan) {
    ...
    if (tanggal < 1 || tanggal > 31 || bulan < 1 || bulan > 12) {
      ...
      console.log("\n===== HASIL =====");
      console.log("Tanggal Lahir : " + tanggal + " " + namaBulan[bulan - 1]);
